...
![Two Stream Deck + dials: CPU temperature with a range bar and session min/max, and GPU Hot Spot pinned at its session maximum in red.]({{ '/assets/img/dials.png' | relative_url }})
