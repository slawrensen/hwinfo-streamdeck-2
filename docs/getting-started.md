...
![The Sensor picker open with "cpu" typed in the search box, showing results grouped under CPU and GPU headings, each row with its live value, unit, and type.]({{ '/assets/img/sensor-picker.png' | relative_url }})
