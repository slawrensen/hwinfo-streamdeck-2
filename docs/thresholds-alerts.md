...
![The Warn at / Critical at / Direction settings in the property inspector, with values fill]({{ '/assets/img/settings-panel.png' | relative_url }})
...
![A CPU temp key in the warn state — full amber field, black value text, showing e.g. 82°C]({{ '/assets/img/themes-contact-sheet.png' | relative_url }})
